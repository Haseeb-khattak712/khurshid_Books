        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-10 shadow-sm">
          ...
          <form className="mt-8 space-y-5" onSubmit={handleRegister}>
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-3xl border border-slate-200 bg-white px-6 py-3 text-sm font-medium text-slate-700 hover:bg-slate-50 transition"
            >
