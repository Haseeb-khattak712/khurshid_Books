              ...
              <div className="flex items-center gap-2 border-r border-slate-200 pr-2 sm:pr-3">
                {user.role === 'admin' ? (
                  <div className="relative group">
                    <Link
                      to="/admin"
                      className="flex items-center gap-1.5 rounded-xl px-2.5 py-1.5 text-xs font-bold text-amber-900 bg-amber-50 border border-amber-200/80 hover:bg-amber-100 transition shadow-2xs"
                    ...
                    {/* Admin Quick Dropdown Menu on hover */}
                    <div className="absolute right-0 top-[calc(100%+4px)] z-50 w-56 overflow-hidden rounded-2xl border border-slate-200 bg-white p-1.5 shadow-xl opacity-0 translate-y-1 invisible group-hover:opacity-100 group-hover:translate-y-0 group-hover:visible transition-all duration-150">
                      <div className="px-3 py-1.5 text-[10px] font-bold uppercase tracking-wider text-slate-400 border-b border-slate-100 mb-1">
                        Admin Controls
                      </div>
                      <Link
                        to="/admin"
                        className="flex items-center gap-2.5 rounded-xl px-3 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-50 hover:text-[var(--brass)] transition"
                      >
                      ...
                      <Link
                        ...
                        className="flex items-center gap-2.5 rounded-xl px-3 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-50 hover:text-[var(--brass)] transition"
                      >
                        <FolderTree size={14} className="text-amber-600" />
